      ...
      <div id="content">
        <div class="center-container">
            <div style="text-align: left;">
                <a href="/kelahiran" class="btn btn-danger btn-sm" style="margin-bottom: 10px; margin-right: 5px; display: inline-block;">
                    <i class="fas fa-plus"></i> Hapus Data
                </a>
                <a href="/editkelahiran" class="btn btn-warning btn-sm" style="margin-bottom: 10px; display: inline-block;">
