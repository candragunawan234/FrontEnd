        ...
        <div class="center-container">
          ...
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Alamat">
            </div>
            <div class="form-group">
              <label for="kota">No Hp</label>
              <input type="number" class="form-control" id="kota" name="kota" placeholder="Masukkan No Hp">
            </div>
            <div class="form-group">
              <label for="umur">Tanggal Lahir</label>
              <input type="number" class="form-control" id="umur" name="umur" placeholder="Masukkan Tanggal Lahir">
            </div>
            <div class="form-group">
                <label for="umur">Waktu Lahir</label>
                <input type="number" class="form-control" id="umur" name="umur" placeholder="Waktu Lahir">
              </div>
              <div class="form-group">
            ...
            <a href="/3" type="submit" class="btn btn-primary">Selanjutnya</a>
            </div>
          </form>
        </div>
      </div>
